...
public class AttributeNames {
	...
	public final static String v_AuxVerb = "Palīgverbs";
	public final static String v_ModalVerb = "Modāls modificētājs";
	public final static String v_PhaseVerb = "Fāzes modificētājs";
	public final static String v_ExpressionalVerb = "Izpausmes modificētājs";
	public final static String v_Buut = "Palīgverbs 'būt'";
	public final static String v_Copula = "Saitiņa";
